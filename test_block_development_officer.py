...
project_data = [(1, 'tata', 'building construction', 'andhra pradesh', 39, 2234000.0, '12-10-2018', '23-12-2020', '2')]

project_data_2 = [1, 'relaince', 'road construction', 'Uttarakhand', 39, 2432000.0, '12-10-2019', '23-12-2020', '2']

pending_project_member = {(1, 2, 3, 4)}

gpm_data = [(1, 2, 'fname', 'lname', 'state', 'address', 243000, 'email'),
            (2, 2, 'fname', 'lname', 'state', 'address', 243000, 'email'),
            (3, 1, 'fname', 'lname', 'state', 'address', 243000, 'email')]

single_gpm_data = [1, 2, 'fname', 'lname', 'state', 'address', 243000, 'email']
...
class TestBlockDevelopmentOfficer:
    ...
    def test_bdo_menu_choice_3(self, arg1, inputs):
        """ Test bdo main menu method."""
    ...
    def test_bdo_menu_choice_4(self, arg1, inputs):
        """ Test bdo main menu method."""
    ...
    def test_bdo_menu_choice_5(self, arg1, inputs):
        """ Test bdo main menu method."""
    ...
    @mock.patch('builtins.input')
    def test_bdo_menu_choice_6(self, inputs):
        """ Test bdo main menu method."""
    ...
    @mock.patch('builtins.input')
    def test_bdo_menu_wrong_choice(self, inputs):
        """ Test bdo main menu method."""
    ...
    @mock.patch('block_development_officer.BlockDevelopmentOfficer.bdo_menu', return_value=True)
