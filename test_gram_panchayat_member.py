...
class TestGramPanchayatMember:
    ...
    def test_gpm_menu_choice_1(self, arg1, inputs):
        """ Test gpm main menu method."""
        inputs.side_effect = ['1', '6']

        assert GPM(object).gpm_menu('test@gmail.com') == True

    @mock.patch('builtins.input')
    @mock.patch('gram_panchayat_member.GramPanchayatMember.gpm_job_card', return_value=True)
    def test_gpm_menu_choice_2(self, arg1, inputs):
        """ Test gpm main menu method."""
    ...
    def test_gpm_menu_choice_3(self, arg1, inputs):
        """ Test gpm main menu method."""
    ...
    def test_gpm_menu_choice_4(self, arg1, inputs):
        """ Test gpm main menu method."""
    ...
    def test_gpm_menu_choice_5(self, arg1, inputs):
        """ Test gpm main menu method."""
    ...
    @mock.patch('builtins.input')
    def test_gpm_menu_wrong_choice(self, inputs):
        """ Test gpm main menu method."""
        inputs.side_effect = ['@', '6']
    ...
    @mock.patch('gram_panchayat_member.GramPanchayatMember.gpm_menu', return_value=True)
