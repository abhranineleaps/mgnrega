...
class BlockDevelopmentOfficer:
    ...
    def bdo_menu(self, email):
        """
        Display all features of a BDO.
        :email of logged in BDO
        """
        print("\nBlock Development Officer\nWELCOMES -> {}".format(email))
        print("\n### BDO MENU ###\n1. Gram Panchayat Member list\n2. Projects list\n3. Pending project requests\n"
    ...
    def add_project_action(self, project_name, project_type, state, members_req, cost_est, start_date_est,
        ...
        :state: state name
        :members_req: members requires in project
        :cost_est: cost of the project
        :start_date_est: start date of the project
        :end_date_est: end date of the project
        :return: True/False
        """
        try:
