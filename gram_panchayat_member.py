...
class GramPanchayatMember:
    ...
    def gpm_menu(self, email):
        """
        Display all features of a GPM.
        : email of logged in GPM
        """
        print("\nGram Panchayat Member\nWELCOMES -> {}".format(email))
        print("\n### GPM MENU ###\n1. List of Members\n2. Issuance of Job card\n3. Work allotment\n4. Work allotment List"
              "\n5. Complaints filed\n6. Logout")
        choice = input("Choice: ")
    ...
    def gpm_members_menu(self):
        """
        Display operations for member to GPM.
        :return: True
        """
        print("\n### MEMBERS MENU ###\n1. Add Member\n2. Update Member\n3. Remove Member\n4. Show Members\n5. GO Back")
        choice = input("Choice: ")
    ...
    def add_member_action(self, fname, lname, email, age, gender, state, address, pincode, place):
        ...
        :pincode: pincode of member
        :place: place of member
        :return: True/False
        """
        try:
    ...
    def work_allotment_action(self, project_result, member_result):
        ...
        :project_result: project detail of a project
        :member_result: member detail of a member
        """
    ...
    def request_list(self):
        """
        Display list of all members assigned to the projects .
        """
        try:
            c = self.conn.cursor()
