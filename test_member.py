...
class TestMember:
    ...
    def test_member_menu_choice_1(self, input, md):
        """ Test member main menu method."""
        md.return_value = True
        assert Member(object).member_menu("test") == True

    @mock.patch('member.Member.raise_complaint_menu')
    @mock.patch('builtins.input', side_effect=['2', '3'])
    def test_member_menu_choice_2(self, input, cmp):
        """ Test member main menu method."""
        cmp.return_value = True
        assert Member(object).member_menu("test") == True

    @mock.patch('builtins.input', return_value='3')
    def test_member_menu_choice_3(self, input):
        """ Test member main menu method."""
        assert Member(object).member_menu("test@gmail.com") == True

    @mock.patch('builtins.input', side_effect=['w', '3'])
    def test_member_menu_wrong_choice(self, input):
        """ Test member main menu method."""
        assert Member(object).member_menu("test@gmail.com") == True
    ...
    @mock.patch('member.Member.member_menu', return_value='')
